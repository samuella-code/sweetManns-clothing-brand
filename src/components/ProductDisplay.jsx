...
const ProductDisplay = (props) => {
  ...
  const images = [product.image, product.image1, product.image2, product.image3]
      ...
      <div className='flex md:1/2 gap-4'>
        <div className='flex flex-col gap-4 md:h-[500px]'>
          {images.map((img, index) => (
            <img key={index} src={img} alt="" className='md:h-[163px] w-[100px]' onClick={() => setSelectedImage(img)} />
          ))}
        </div>
        <div>
